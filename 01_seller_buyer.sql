...
CREATE TABLE `merchant_bucket_history` (
	...
	`mh_shop_id` VARCHAR(20) COLLATE utf8mb4_bin NOT NULL,
	...
	PRIMARY KEY (`mh_id`)
	KEY `merchant_bucket_history_idx01`(`mh_txn_date`,`mh_merchant_id`,`mh_shop_id`,`mh_ccy`)
	KEY `merchant_bucket_history_idx02`(`mh_merchant_id`,`mh_ccy`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
